    ...
    <>
      ...
      <ToastContainer
        ...
        icon={({ type }) => {
          switch (type) {
            case 'success': {
              return <div className="i-ph:check-bold text-igriz-elements-icon-success text-2xl" />;
            }
            case 'error': {
              return <div className="i-ph:warning-circle-bold text-igriz-elements-icon-error text-2xl" />;
            }
          }

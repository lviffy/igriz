...
export const ModelSelector = ({
  ...
  if (providerList.length === 0) {
    return (
      <div className="mb-2 p-4 rounded-lg border border-igriz-elements-borderColor bg-igriz-elements-prompt-background text-igriz-elements-textPrimary">
      ...
      <div className="relative flex w-full" onKeyDown={handleProviderKeyDown} ref={providerDropdownRef}>
        <div
          className={classNames(
            'w-full p-2 rounded-lg border border-igriz-elements-borderColor',
            'bg-igriz-elements-prompt-background text-igriz-elements-textPrimary',
            'focus-within:outline-none focus-within:ring-2 focus-within:ring-igriz-elements-focus',
            'transition-all cursor-pointer',
            isProviderDropdownOpen ? 'ring-2 ring-igriz-elements-focus' : undefined,
          )}
        ...
        >
          <div className="flex items-center justify-between">
            ...
            <div
              className={classNames(
                'i-ph:caret-down w-4 h-4 text-igriz-elements-textSecondary opacity-75',
        ...
        {isProviderDropdownOpen && (
          <div
            className="absolute z-20 w-full mt-1 py-1 rounded-lg border border-igriz-elements-borderColor bg-igriz-elements-background-depth-2 shadow-lg"
            role="listbox"
            id="provider-listbox"
          >
              ...
              <div className="relative">
                <input
                  ...
                  className={classNames(
                    ...
                    'bg-igriz-elements-background-depth-2 border border-igriz-elements-borderColor',
                    'text-igriz-elements-textPrimary placeholder:text-igriz-elements-textTertiary',
                ...
                <div className="absolute left-2.5 top-1/2 -translate-y-1/2">
                  <span className="i-ph:magnifying-glass text-igriz-elements-textTertiary" />
                </div>
                {providerSearchQuery && (
                  <button
                    type="button"
                    ...
                    className="absolute right-2.5 top-1/2 -translate-y-1/2 p-0.5 rounded hover:bg-igriz-elements-background-depth-3 transition-colors"
                    aria-label="Clear search"
                  >
                    <span className="i-ph:x text-igriz-elements-textTertiary text-xs" />
                  </button>
                )}
              </div>
            </div>
            ...
            <div
              className={classNames(
                ...
                '[&::-webkit-scrollbar-thumb]:bg-igriz-elements-borderColor',
                '[&::-webkit-scrollbar-thumb]:hover:bg-igriz-elements-borderColorHover',
                '[&::-webkit-scrollbar-thumb]:rounded-full',
                '[&::-webkit-scrollbar-track]:bg-igriz-elements-background-depth-2',
                '[&::-webkit-scrollbar-track]:rounded-full',
                'sm:[&::-webkit-scrollbar]:w-1.5 sm:[&::-webkit-scrollbar]:h-1.5',
                'sm:hover:[&::-webkit-scrollbar-thumb]:bg-igriz-elements-borderColor/50',
                'sm:hover:[&::-webkit-scrollbar-thumb:hover]:bg-igriz-elements-borderColor',
                'sm:[&::-webkit-scrollbar-track]:bg-transparent',
              )}
            >
              {filteredProviders.length === 0 ? (
                <div className="px-3 py-3 text-sm">
                  <div className="text-igriz-elements-textTertiary mb-1">
                    {debouncedProviderSearchQuery
                      ? `No providers match "${debouncedProviderSearchQuery}"`
                      : 'No providers found'}
                  </div>
                  {debouncedProviderSearchQuery && (
                    <div className="text-xs text-igriz-elements-textTertiary">
                ...
                filteredProviders.map((providerOption, index) => (
                  <div
                    ...
                    className={classNames(
                      ...
                      'hover:bg-igriz-elements-background-depth-3',
                      'text-igriz-elements-textPrimary',
                      'outline-none',
                      provider?.name === providerOption.name || focusedProviderIndex === index
                        ? 'bg-igriz-elements-background-depth-2'
                        : undefined,
                      focusedProviderIndex === index ? 'ring-1 ring-inset ring-igriz-elements-focus' : undefined,
                    )}
                    onClick={(e) => {
                      e.stopPropagation();
      ...
      <div className="relative flex w-full min-w-[70%]" onKeyDown={handleModelKeyDown} ref={modelDropdownRef}>
        <div
          className={classNames(
            ...
            'focus-within:outline-none focus-within:ring-2 focus-within:ring-igriz-elements-focus',
            'transition-all cursor-pointer',
            isModelDropdownOpen ? 'ring-2 ring-igriz-elements-focus' : undefined,
          )}
        ...
        {isModelDropdownOpen && (
          <div
            className="absolute z-10 w-full mt-1 py-1 rounded-lg border border-igriz-elements-borderColor bg-igriz-elements-background-depth-2 shadow-lg"
            role="listbox"
            id="model-listbox"
          >
            <div className="px-2 pb-2 space-y-2">
              ...
              {provider?.name === 'OpenRouter' && (
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className={classNames(
                      ...
                      showFreeModelsOnly
                        ...
                        : 'bg-igriz-elements-background-depth-3 text-igriz-elements-textSecondary border border-igriz-elements-borderColor',
                    )}
                  >
                  ...
                  {showFreeModelsOnly && (
                    <span className="text-xs text-igriz-elements-textTertiary">
              ...
              {debouncedModelSearchQuery && filteredModels.length > 0 && (
                <div className="text-xs text-igriz-elements-textTertiary px-1">
            ...
            >
              {modelLoading === 'all' || modelLoading === provider?.name ? (
                <div className="px-3 py-3 text-sm">
                  <div className="flex items-center gap-2 text-igriz-elements-textTertiary">
                ...
                <div className="px-3 py-3 text-sm">
                  ...
                  {!debouncedModelSearchQuery && provider?.name && LOCAL_PROVIDERS.includes(provider.name) && (
                    <div className="text-xs text-igriz-elements-textTertiary mt-1">
                  ...
                  <div
                    ...
                    className={classNames(
                      ...
                      model === modelOption.name || focusedModelIndex === index
                        ? 'bg-igriz-elements-background-depth-2'
                        : undefined,
                      focusedModelIndex === index ? 'ring-1 ring-inset ring-igriz-elements-focus' : undefined,
                    )}
                    onClick={(e) => {
                      e.stopPropagation();

...
export const ExportChatButton = ({ exportChat }: { exportChat?: () => void }) => {
  return (
    <div className="flex border border-igriz-elements-borderColor rounded-md overflow-hidden">
      <DropdownMenu.Root>
        ...
        >
          <DropdownMenu.Item
            className={classNames(
              'cursor-pointer flex items-center w-auto px-4 py-2 text-sm text-igriz-elements-textPrimary hover:bg-igriz-elements-item-backgroundActive gap-2 rounded-md group relative',
            )}
            onClick={() => {

      ...
      >
        <div
          className={classNames(
            ...
            'p-1 rounded-lg text-igriz-elements-item-contentAccent',
            'flex ',
          )}
        >
          ...
          <motion.button
            ...
            className=" p-1 rounded-lg bg-igriz-elements-item-backgroundAccent hover:bg-igriz-elements-artifacts-backgroundHover"

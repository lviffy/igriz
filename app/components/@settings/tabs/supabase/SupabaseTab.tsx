...
export default function SupabaseTab() {
  ...
  const renderProjects = () => {
    if (fetchingStats) {
      return (
        <div className="flex items-center gap-2 text-sm text-igriz-elements-textSecondary">
    ...
    return (
      <Collapsible open={isProjectsExpanded} onOpenChange={setIsProjectsExpanded}>
        <CollapsibleTrigger asChild>
          <div className="flex items-center justify-between p-4 rounded-lg bg-igriz-elements-background dark:bg-igriz-elements-background-depth-2 border border-igriz-elements-borderColor dark:border-igriz-elements-borderColor hover:border-igriz-elements-borderColorActive/70 dark:hover:border-igriz-elements-borderColorActive/70 transition-all duration-200 cursor-pointer">
            <div className="flex items-center gap-2">
              <div className="i-ph:database w-4 h-4 text-igriz-elements-item-contentAccent" />
              <span className="text-sm font-medium text-igriz-elements-textPrimary">
                Your Projects ({connection.stats?.totalProjects || 0})
              </span>
            </div>
            <div
              className={classNames(
                'i-ph:caret-down w-4 h-4 transform transition-transform duration-200 text-igriz-elements-textSecondary',
        ...
        <CollapsibleContent className="overflow-hidden">
          <div className="space-y-4 mt-4">
            ...
            {connection.stats?.projects?.length ? (
              <div className="mb-6 p-4 bg-igriz-elements-background-depth-1 rounded-lg border border-igriz-elements-borderColor">
                <h4 className="text-sm font-medium text-igriz-elements-textPrimary mb-3">Supabase Overview</h4>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div className="text-center">
                    <div className="text-2xl font-bold text-igriz-elements-textPrimary">
                      {connection.stats.totalProjects}
                    </div>
                    <div className="text-xs text-igriz-elements-textSecondary">Total Projects</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-igriz-elements-textPrimary">
                      {connection.stats.projects.filter((p: SupabaseProject) => p.status === 'ACTIVE_HEALTHY').length}
                    </div>
                    <div className="text-xs text-igriz-elements-textSecondary">Active Projects</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-igriz-elements-textPrimary">
                      {new Set(connection.stats.projects.map((p: SupabaseProject) => p.region)).size}
                    </div>
                    <div className="text-xs text-igriz-elements-textSecondary">Regions Used</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-igriz-elements-textPrimary">
                      {connection.stats.projects.filter((p: SupabaseProject) => p.status !== 'ACTIVE_HEALTHY').length}
                    </div>
                    <div className="text-xs text-igriz-elements-textSecondary">Inactive Projects</div>
                  </div>
                </div>
              </div>
            ) : null}
            ...
            {connection.stats?.projects?.length ? (
              <div className="grid gap-3">
                {connection.stats.projects.map((project: SupabaseProject) => (
                  <div
                    key={project.id}
                    className={classNames(
                      'p-4 rounded-lg border transition-colors bg-igriz-elements-background-depth-1 cursor-pointer',
                      selectedProjectId === project.id
                        ? 'border-igriz-elements-item-contentAccent bg-igriz-elements-item-backgroundActive/10'
                        : 'border-igriz-elements-borderColor hover:border-igriz-elements-borderColorActive/70',
                    )}
                    onClick={() => handleProjectSelect(project.id)}
                  >
                    <div className="flex items-center justify-between">
                      <div className="flex-1">
                        <h5 className="text-sm font-medium text-igriz-elements-textPrimary flex items-center gap-2">
                          <div className="i-ph:database w-4 h-4 text-igriz-elements-borderColorActive" />
                          {project.name}
                        </h5>
                        <div className="flex items-center gap-2 mt-2 text-xs text-igriz-elements-textSecondary">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mt-3 pt-3 border-t border-igriz-elements-borderColor">
                          <div className="text-center">
                            <div className="text-sm font-semibold text-igriz-elements-textPrimary">
                              {project.stats?.database?.tables ?? '--'}
                            </div>
                            <div className="text-xs text-igriz-elements-textSecondary flex items-center justify-center gap-1">
                    ...
                    {selectedProjectId === project.id && (
                      <div className="space-y-4 mt-4 pt-4 border-t border-igriz-elements-borderColor">
                        <div className="flex flex-wrap items-center gap-1">
                          {projectActions.map((action) => (
                            <Button
                              ...
                              className="flex items-center gap-1 text-xs px-2 py-1 text-igriz-elements-textPrimary dark:text-igriz-elements-textPrimary"
                            >
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          <div className="bg-igriz-elements-background-depth-2 p-3 rounded-lg space-y-2">
                            <h6 className="text-xs font-medium text-igriz-elements-textPrimary flex items-center gap-2">
                              <div className="i-ph:database w-4 h-4 text-igriz-elements-item-contentAccent" />
                              Database Schema
                            </h6>
                            <div className="space-y-1 text-xs text-igriz-elements-textSecondary">
                          ...
                          <div className="bg-igriz-elements-background-depth-2 p-3 rounded-lg space-y-2">
                            <h6 className="text-xs font-medium text-igriz-elements-textPrimary flex items-center gap-2">
                              <div className="i-ph:folder w-4 h-4 text-igriz-elements-item-contentAccent" />
                              Storage
                            </h6>
                            <div className="space-y-1 text-xs text-igriz-elements-textSecondary">
                              <div className="flex justify-between">
                        ...
                        {connection.credentials && (
                          <div className="bg-igriz-elements-background-depth-2 p-3 rounded-lg space-y-2">
                            <h6 className="text-xs font-medium text-igriz-elements-textPrimary flex items-center gap-2">
                              <div className="i-ph:key w-4 h-4 text-igriz-elements-item-contentAccent" />
                              Project Credentials
                            </h6>
                            <div className="space-y-2">
                              <div>
                                <label className="text-xs text-igriz-elements-textSecondary">Supabase URL:</label>
                                <div className="flex items-center gap-2 mt-1">
                                  <input
                                    type="text"
                                    value={connection.credentials.supabaseUrl || ''}
                                    readOnly
                                    className="flex-1 px-2 py-1 text-xs bg-igriz-elements-background border border-igriz-elements-borderColor rounded"
                                  />
                                  <Button
                                    size="icon"
                                    variant="outline"
                              ...
                              <div>
                                <label className="text-xs text-igriz-elements-textSecondary">Anon Key:</label>
                                <div className="flex items-center gap-2 mt-1">
                                  <input
                                    type="password"
              ...
              <div className="text-sm text-igriz-elements-textSecondary flex items-center gap-2 p-4">
    ...
    <div className="space-y-6">
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-lg font-medium text-igriz-elements-textPrimary dark:text-igriz-elements-textPrimary">
        ...
        <div className="flex items-center gap-2">
          {connection.user && (
            <Button
              ...
              variant="outline"
              size="sm"
              className="flex items-center gap-2 hover:bg-igriz-elements-item-backgroundActive/10 hover:text-igriz-elements-textPrimary dark:hover:bg-igriz-elements-item-backgroundActive/10 dark:hover:text-igriz-elements-textPrimary transition-colors"
            >
      ...
      <p className="text-sm text-igriz-elements-textSecondary dark:text-igriz-elements-textSecondary">
      ...
      <motion.div
        className="bg-igriz-elements-background dark:bg-igriz-elements-background border border-igriz-elements-borderColor dark:border-igriz-elements-borderColor rounded-lg"
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        ...
        <div className="p-6 space-y-6">
          {!connection.user ? (
            <div className="space-y-4">
              <div className="text-xs text-igriz-elements-textSecondary bg-igriz-elements-background-depth-1 dark:bg-igriz-elements-background-depth-1 p-3 rounded-lg mb-4">
                <p className="flex items-center gap-1 mb-1">
                  <span className="i-ph:lightbulb w-3.5 h-3.5 text-igriz-elements-icon-success dark:text-igriz-elements-icon-success" />
                  <span className="font-medium">Tip:</span> You can also set the{' '}
                  <code className="px-1 py-0.5 bg-igriz-elements-background-depth-2 dark:bg-igriz-elements-background-depth-2 rounded">
              ...
              <div>
                <label className="block text-sm text-igriz-elements-textSecondary mb-2">Access Token</label>
                <input
                  type="password"
                  value={tokenInput}
                  ...
                  className={classNames(
                    ...
                    'text-igriz-elements-textPrimary placeholder-igriz-elements-textTertiary',
                    'focus:outline-none focus:ring-1 focus:ring-igriz-elements-borderColorActive',
                    'disabled:opacity-50',
                  )}
                />
                <div className="mt-2 text-sm text-igriz-elements-textSecondary">
                  <a
                    href="https://supabase.com/dashboard/account/tokens"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-igriz-elements-borderColorActive hover:underline inline-flex items-center gap-1"
                  >
                    Get your token
            ...
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm text-igriz-elements-textSecondary flex items-center gap-1">
              ...
              {connection.user && (
                <div className="space-y-4">
                  <div className="flex items-center gap-4 p-4 bg-igriz-elements-background-depth-1 dark:bg-igriz-elements-background-depth-1 rounded-lg">
                    <div className="w-12 h-12 rounded-full bg-gradient-to-br from-green-400 to-green-600 flex items-center justify-center">
                      <div className="i-ph:user w-6 h-6 text-white" />
                    </div>
                    <div className="flex-1">
                      <h4 className="text-sm font-medium text-igriz-elements-textPrimary">{connection.user.email}</h4>
                      <p className="text-sm text-igriz-elements-textSecondary">
                        {connection.user.role} • Member since{' '}
                        {new Date(connection.user.created_at).toLocaleDateString()}
                      </p>
                      <div className="flex items-center gap-4 mt-2 text-xs text-igriz-elements-textSecondary">
                        <span className="flex items-center gap-1">
                  ...
                  <div className="mb-6 space-y-4">
                    <h4 className="text-sm font-medium text-igriz-elements-textPrimary">Performance Analytics</h4>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <div className="bg-igriz-elements-background-depth-2 p-3 rounded-lg border border-igriz-elements-borderColor">
                        <h6 className="text-xs font-medium text-igriz-elements-textPrimary flex items-center gap-2 mb-2">
                          <div className="i-ph:chart-line w-4 h-4 text-igriz-elements-item-contentAccent" />
                          Database Health
                        </h6>
                        <div className="space-y-1">
                          {(() => {
                            ...
                            <div key={idx} className="flex justify-between text-xs">
                              <span className="text-igriz-elements-textSecondary">{item.label}:</span>
                              <span className="text-igriz-elements-textPrimary font-medium">{item.value}</span>
                            </div>
                          ))}
                        </div>
                      </div>
                      ...
                      <div className="bg-igriz-elements-background-depth-2 p-3 rounded-lg border border-igriz-elements-borderColor">
                        <h6 className="text-xs font-medium text-igriz-elements-textPrimary flex items-center gap-2 mb-2">
                          <div className="i-ph:shield-check w-4 h-4 text-igriz-elements-item-contentAccent" />
                          Auth & Security
                        </h6>
                        <div className="space-y-1">
                          {(() => {
                      ...
                      <div className="bg-igriz-elements-background-depth-2 p-3 rounded-lg border border-igriz-elements-borderColor">
                        <h6 className="text-xs font-medium text-igriz-elements-textPrimary flex items-center gap-2 mb-2">
                          <div className="i-ph:globe w-4 h-4 text-igriz-elements-item-contentAccent" />
                  ...
                  <div className="mb-6">
                    <h4 className="text-sm font-medium text-igriz-elements-textPrimary mb-2">Resource Overview</h4>
                    <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                      {(() => {
                        ...
                        <div
                          key={index}
                          className={`flex flex-col p-3 rounded-lg border border-igriz-elements-borderColor ${metric.bgColor}`}
                        >
                          <div className="flex items-center gap-2 mb-1">
                            <div className={`${metric.icon} w-4 h-4 ${metric.color}`} />
                            <span className="text-xs text-igriz-elements-textSecondary">{metric.label}</span>
                          </div>
                  ...
                  {/* Usage Metrics */}
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="p-3 bg-igriz-elements-background-depth-1 rounded-lg border border-igriz-elements-borderColor">
                      <div className="flex items-center gap-2 mb-2">
                        <div className="i-ph:database w-4 h-4 text-igriz-elements-item-contentAccent" />
                        <span className="text-xs font-medium text-igriz-elements-textPrimary">Database</span>
                      </div>
                      <div className="text-sm text-igriz-elements-textSecondary">
                        <div>
                          Tables:{' '}
                          {connection.stats?.projects?.reduce((sum, p) => sum + (p.stats?.database?.tables || 0), 0) ||
                            '--'}
                    ...
                    <div className="p-3 bg-igriz-elements-background-depth-1 rounded-lg border border-igriz-elements-borderColor">
                      <div className="flex items-center gap-2 mb-2">
                        <div className="i-ph:folder w-4 h-4 text-igriz-elements-item-contentAccent" />
                        <span className="text-xs font-medium text-igriz-elements-textPrimary">Storage</span>
                      </div>
                      <div className="text-sm text-igriz-elements-textSecondary">
                        <div>
                          Buckets:{' '}
                    ...
                    <div className="p-3 bg-igriz-elements-background-depth-1 rounded-lg border border-igriz-elements-borderColor">
                      <div className="flex items-center gap-2 mb-2">
                        <div className="i-ph:code w-4 h-4 text-igriz-elements-item-contentAccent" />
                        <span className="text-xs font-medium text-igriz-elements-textPrimary">Functions</span>
                      </div>
                      <div className="text-sm text-igriz-elements-textSecondary">
                        <div>
                          Deployed:{' '}

...
// Create a custom hook to connect to the igrizHistory database
function useigrizHistoryDB() {
...
export function DataTab() {
  // Use our custom hook for the igrizHistory database
  const { db, isLoading: dbLoading } = useigrizHistoryDB();
  ...
  // Data operations hook with igrizHistory database
  const {
    isExporting,
    isImporting,
    isResetting,
    ...
    customDb: db || undefined, // Pass the igrizHistory database, converting null to undefined
  ...
  useEffect(() => {
    if (db) {
      console.log('Loading chats from igrizHistory database', {
        name: db.name,
        version: db.version,
  ...
  return (
    <div className="space-y-12">
      ...
      {/* Chats Section */}
      <div>
        <h2 className="text-xl font-semibold mb-4 text-igriz-elements-textPrimary">Chats</h2>
        {dbLoading ? (
            ...
            <Card>
              <CardHeader>
                <div className="flex items-center mb-2">
                  ...
                  <CardTitle className="text-lg group-hover:text-igriz-elements-item-contentAccent transition-colors">
                    Export All Chats
                  </CardTitle>
                </div>
                ...
                <motion.div whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }} className="w-full">
                  <Button
                    ...
                    className={classNames(
                      'hover:text-igriz-elements-item-contentAccent hover:border-igriz-elements-item-backgroundAccent hover:bg-igriz-elements-item-backgroundAccent transition-colors w-full justify-center',
      ...
      {/* Settings Section */}
      <div>
        <h2 className="text-xl font-semibold mb-4 text-igriz-elements-textPrimary">Settings</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <Card>
            <CardHeader>
              <div className="flex items-center mb-2">
      ...
      {/* API Keys Section */}
      <div>
        <h2 className="text-xl font-semibold mb-4 text-igriz-elements-textPrimary">API Keys</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <Card>
            <CardHeader>
              <div className="flex items-center mb-2">
      ...
      {/* Data Visualization */}
      <div>
        <h2 className="text-xl font-semibold mb-4 text-igriz-elements-textPrimary">Data Usage</h2>
        <Card>

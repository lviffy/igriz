      ...
      <div className="flex items-center gap-1.5">
        ...
        <span
          className={classNames(
            isLast
              ? 'font-medium text-igriz-elements-textPrimary dark:text-igriz-elements-textPrimary-dark'
              : 'text-igriz-elements-textSecondary dark:text-igriz-elements-textSecondary-dark hover:text-igriz-elements-textPrimary dark:hover:text-igriz-elements-textPrimary-dark',
            ...
            <li key={index} className="flex items-center">
              ...
              {!isLast && (
                <span
                  className={classNames(
                    separator,
                    'w-3 h-3 mx-1 text-igriz-elements-textTertiary dark:text-igriz-elements-textTertiary-dark',
                  )}
                />
              )}
            </li>

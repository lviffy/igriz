        ...
        <button
          ...
          className={classNames(
            ...
            tab.id === activeTab
              ...
              : classNames(
                  'bg-igriz-elements-background-depth-2 dark:bg-igriz-elements-background-depth-3 text-igriz-elements-textPrimary dark:text-igriz-elements-textPrimary-dark hover:bg-igriz-elements-background-depth-3 dark:hover:bg-igriz-elements-background-depth-4 border border-igriz-elements-borderColor dark:border-igriz-elements-borderColor-dark',
                  tabClassName,
                ),
          )}
        >

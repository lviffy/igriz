      ...
      try {
        ...
        reader.onload = (e) => {
          ...
          if (textarea) {
            ...
            const setUploadedFiles = (window as any).__igriz_SET_UPLOADED_FILES__;
            const setImageDataList = (window as any).__igriz_SET_IMAGE_DATA_LIST__;
            const uploadedFiles = (window as any).__igriz_UPLOADED_FILES__ || [];
            const imageDataList = (window as any).__igriz_IMAGE_DATA_LIST__ || [];

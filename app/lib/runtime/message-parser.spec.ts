...
describe('StreamingMessageParser', () => {
  ...
  describe('no artifacts', () => {
    ...
    ])('should correctly parse chunks and strip out igriz artifacts (%#)', (input, expected) => {
  ...
  describe('invalid or incomplete artifacts', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      ...
      ['Foo bar <bol', 'Foo bar '],
      ['Foo bar <igriz', 'Foo bar '],
      ['Foo bar <igriza', 'Foo bar <igriza'],
      ['Foo bar <igrizA', 'Foo bar '],
      ['Foo bar <igrizArtifacs></igrizArtifact>', 'Foo bar <igrizArtifacs></igrizArtifact>'],
      ['Before <oltArtfiact>foo</igrizArtifact> After', 'Before <oltArtfiact>foo</igrizArtifact> After'],
      ['Before <igrizArtifactt>foo</igrizArtifact> After', 'Before <igrizArtifactt>foo</igrizArtifact> After'],
    ])('should correctly parse chunks and strip out igriz artifacts (%#)', (input, expected) => {
      runTest(input, expected);
    });
  });
  ...
  describe('valid artifacts without actions', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      [
        'Some text before <igrizArtifact title="Some title" id="artifact_1">foo bar</igrizArtifact> Some more text',
        {
      ...
      [
        [
          'Some text before <igrizArti',
          'fact',
          ' title="Some title" id="artifact_1" type="bundled" >foo</igrizArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        [
          ...
          ' ',
          '>',
          'foo</igrizArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        [
          ...
          ' >fo',
          'o</igrizArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        'Before <igrizArtifact title="Some title" id="artifact_1">foo</igrizArtifact> After',
        {
          output: 'Before  After',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
        },
  ...
  describe('valid artifacts with actions', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      [
        'Before <igrizArtifact title="Some title" id="artifact_1"><igrizAction type="shell">npm install</igrizAction></igrizArtifact> After',
        {
          output: 'Before  After',
      ...
      [
        'Before <igrizArtifact title="Some title" id="artifact_1"><igrizAction type="shell">npm install</igrizAction><igrizAction type="file" filePath="index.js">some content</igrizAction></igrizArtifact> After',
        {
          output: 'Before  After',

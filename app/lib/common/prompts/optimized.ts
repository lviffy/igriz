...
<artifact_info>
  ...
  - Use \`<igrizArtifact>\` tags with \`title\` and \`id\` attributes
  - Use \`<igrizAction>\` tags with \`type\` attribute:
    - shell: Run commands
...
## Artifact Usage
22. Use \`<igrizArtifact>\` tags with \`title\` and \`id\` attributes for each project
23. Use \`<igrizAction>\` tags with appropriate \`type\` attribute:
